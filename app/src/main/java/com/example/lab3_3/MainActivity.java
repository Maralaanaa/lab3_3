...
public class MainActivity extends AppCompatActivity {
    ...
    public class MyGridAdapter extends BaseAdapter {
        Context context;
        Integer[] posterID = {R.drawable.bird1, R.drawable.bird2, R.drawable.bird3, R.drawable.bird4, R.drawable.bird5, R.drawable.bird6, R.drawable.bird7, R.drawable.bird8, R.drawable.bird9, R.drawable.bird10, R.drawable.bird11, R.drawable.bird12};
        ...
        public View getView(int position, View arg1, ViewGroup arg2) {
            ...
            imView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ImageView ivPoster = (ImageView) dialogView.findViewById(R.id.ivPost);
